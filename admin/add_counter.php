                            ...
                            <div class="edit-personal-info mb-5">
                                ...
                                <form method="post" action="" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row align-items-center">
                                        ...
                                        <div class="col-9">
                                            <input type="text" id="counter_icon" class="form-control <?php if (isset($counter_icon_error)) echo 'is-invalid' ?>" name="counter_icon" value = "<?php if(isset($_POST['counter_icon'])) echo  $_POST['counter_icon']?>">
                                    ...
                                    <div class="form-group row align-items-center">
                                        ...
                                        <div class="col-9">
                                            <input type="phone" class="form-control <?php if (isset($counter_number_error)) echo 'is-invalid' ?>" id="counter_number" name="counter_number" value = "<?php if(isset($_POST['counter_number'])) echo  $_POST['counter_number']?>">
                                            <?php
