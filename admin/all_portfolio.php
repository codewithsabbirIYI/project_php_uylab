                    ...
                    <div class="card mb-30">
                        <div class="card-body">
                            <div class="d-sm-flex justify-content-between align-items-center">
                                <h4 class="font-20">All portfolio Information</h4>
                                ...
                                <div class="d-flex flex-wrap">
                                    ...
                                    <div class="dropdown-button mt-3 mt-sm-0">
                                        <a href="add_portfolio_item.php" type="button" class="btn style--two orange">Add New</a>
                                    </div>
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="text-nowrap dh-table">
                                ...
                                <tbody>
                                    ...
                                    <?php
                                    $sel = "SELECT * FROM portfolios ORDER BY id ASC";
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><i class="<?= $data['portfolio_icon']; ?>"></i></td>
                                            <td>
                                                ...
                                                ?>
                                                    <img height="40" style="width: 100px;" class="img200" src="uploads/<?= $data['portfolio_image']; ?>" alt="portfolio" />
                                                <?php
                                                } else {
                                                ?>
                                                    <img height="40" src="images/avatar.jpg" alt="portfolio" />
                                                <?php
                                                }
                                            ...
                                            <td>
                                                ...
                                                <div class="dropdown-button">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right" x-placement="top-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(1004px, 82px, 0px);">
                                                        <a href="view-portfolio.php?e=<?= $data["id"]; ?>">View</a>
                                                        <a href="view-portfolio.php?e=<?= $data["id"]; ?>">Edit</a>

                                                        <a href="delete-portfolio.php?d=<?= $data["id"]; ?>">Delete</a>
                                                    </div>
                                                </div>
                                                <!-- End Dropdown Button -->
                                            </td>
